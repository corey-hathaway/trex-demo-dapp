...
interface ClaimTopicsDeploymentProps {
  onComplete?: () => void;
}

export function ClaimTopicsDeployment({ onComplete }: ClaimTopicsDeploymentProps) {
  ...
  React.useEffect(() => {
    if (userAddress && !formData.salt) {
      const defaultSalt = `CTR_${Date.now()}_${userAddress.slice(-6)}`;
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      const bytecode = await loadClaimTopicsRegistryProxyBytecode();
      ...
      await deployContract({
        abi: claimtopicsregistryproxyAbi,
        bytecode: bytecode,
    ...
    <div className="max-w-2xl mx-auto mb-8">
      ...
      <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-4 rounded-t-lg">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold">Step 2 of 5: ClaimTopics Registry</h2>
            <p className="text-purple-100">Manages claim topic requirements for T-REX tokens</p>
          </div>
      ...
      <div className="bg-white border-l border-r border-purple-200 p-6">
        ...
        <div className="bg-gray-50 rounded-md p-4 mb-4">
          ...
          <p className="text-gray-600 text-sm mb-2">
            The ClaimTopics Registry defines what types of claims are required for token holders. 
            It specifies claim categories like KYC verification, accreditation status, 
            or regulatory compliance that must be present for token transfers.
          </p>
          <p className="text-gray-600 text-sm">
            <span className="font-medium">Example claim topics:</span> Identity verification, 
            Accredited investor status, Country restrictions, AML compliance.
          </p>
        </div>
              ...
              <div className="mb-4">
                ...
                <div className="bg-gray-50 rounded-md p-3">
                  <p className="text-sm text-gray-600">
                    <span className="font-medium">Contract:</span> ClaimTopicsRegistryProxy
                  </p>
                  <p className="text-sm text-gray-600">
                    <span className="font-medium">Constructor:</span> Implementation Authority Address
                  </p>
                  <p className="text-sm text-gray-600">
                    <span className="font-medium">Purpose:</span> Define required claim types for tokens
                  </p>
                </div>
              </div>
          ...
          <div className="border border-purple-200 rounded-lg p-6 text-center">
            ...
            {hash && (
              <div className="mt-4 bg-purple-50 rounded-md p-3">
                ...
                <code className="text-xs text-purple-800 break-all">{hash}</code>
              </div>
            )}
          </div>
        )}
        ...
        {step === 'success' && deployedContract && (
          <div className="border border-green-200 rounded-lg p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-green-800 mb-2">
              ClaimTopics Registry Deployed Successfully!
            </h3>
            ...
            <div className="bg-blue-50 border-2 border-blue-300 rounded-md p-4 mb-4">
              ...
              <p className="text-xs text-blue-600 mt-2">
                This is your deployed ClaimTopics Registry contract address!
              </p>
            </div>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-md p-4 mb-4">
              ...
              <ul className="text-purple-800 text-sm text-left space-y-1">
                ...
                <li>• Proceed to Step 3: IdentityRegistry Storage deployment</li>
                <li>• You'll need this ClaimTopics address when deploying IdentityRegistry</li>
                <li>• After complete setup, configure required claim topics</li>
              </ul>
            </div>
          ...
          <div className="border border-red-200 rounded-lg p-6 text-center">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-4">
              ...
              <ul className="text-yellow-800 text-sm text-left space-y-1">
                ...
                <li>• Missing prerequisites (TrustedIssuers Registry)</li>
              </ul>
            </div>
      ...
      <div className="bg-gray-50 border border-t-0 border-purple-200 rounded-b-lg p-4">
        <div className="flex items-center justify-between text-sm text-gray-600">
          <span>Progress: Step 2 of 5</span>
          <div className="flex space-x-1">
            <div className="w-8 h-2 bg-blue-500 rounded" title="Step 1: TrustedIssuers"></div>
            <div className="w-8 h-2 bg-purple-500 rounded" title="Step 2: ClaimTopics (Current)"></div>
